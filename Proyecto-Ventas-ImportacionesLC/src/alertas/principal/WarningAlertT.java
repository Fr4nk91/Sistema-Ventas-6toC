 ...
 * @author Rojeru San
 */
public class WarningAlertT extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertT(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int elimina = TrabajadorDAO.eliminar(Integer.parseInt(this.id.getText()));
        if (elimina != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertT dialog = new WarningAlertT(new javax.swing.JFrame(), true);
