...
public class FormVentasProductos extends javax.swing.JDialog {
     ...
     */
    public FormVentasProductos(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        FadeEffect.fadeOut(this, 50, 0.1f);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVentasProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormVentasProductos dialog = new FormVentasProductos(new javax.swing.JFrame(), true);
