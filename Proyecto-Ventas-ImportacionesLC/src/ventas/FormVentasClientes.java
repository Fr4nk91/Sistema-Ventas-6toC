...
public class FormVentasClientes extends javax.swing.JDialog {

    /**
     * Creates new form Principal
     */
    public FormVentasClientes(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRE", "APELLIDO", "DOCUMENTO", "TELEFONO", "EMAIL", "DIRECCIÓN"
            }
        ) {
...
//        FadeEffect.fadeOut(this, 50, 0.1f);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ClienteDAO.listar(this.buscar.getText(),false);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                this.codigoCliente = this.tabla.getValueAt(fila, 0).toString();
                this.nombreCliente = this.tabla.getValueAt(fila, 1).toString() + ", " + this.tabla.getValueAt(fila, 2).toString();
                this.dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVentasClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormVentasClientes dialog = new FormVentasClientes(new javax.swing.JFrame(), true);
