...
public class FormVentasBuscar extends javax.swing.JDialog {

    /**
     * Creates new form Principal
     */
    public FormVentasBuscar(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Funciones.ocultarColumnas(tabla, new int[]{1, 3});
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODVENTA", "CODCLIENTE", "CLIENTE", "CODUSUARIO", "TRABAJADOR", "FECHA", "$TOTAL"
            }
        ) {
...
//        FadeEffect.fadeOut(this, 50, 0.1f);
        ...
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                er.setVisible(true);
                    ...
                    seleccionaFila(this.tabla.getValueAt(fila, 0).toString());
                    this.codigoVenta = this.tabla.getValueAt(fila, 0).toString();
                    this.dispose();
                   }
            } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVentasBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormVentasBuscar dialog = new FormVentasBuscar(new javax.swing.JFrame(), true);
