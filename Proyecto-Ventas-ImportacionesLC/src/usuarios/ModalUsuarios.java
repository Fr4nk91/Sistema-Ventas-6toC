...
public class ModalUsuarios extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtTrabajador = new app.bolivia.swing.JCTextField();
        jLabel1 = new javax.swing.JLabel();
        btnBuscarTrabajador = new principal.MaterialButton();
        codigoTrabajador = new javax.swing.JLabel();
        ...
        txtTrabajador.setForeground(new java.awt.Color(58, 159, 171));
        txtTrabajador.setToolTipText("");
        txtTrabajador.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtTrabajador.setName(""); // NOI18N
        txtTrabajador.setPlaceholder("TRABAJADOR");
        jPanel4.add(txtTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 320, 240, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ventas/campo-cliente.png"))); // NOI18N
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 310, -1, -1));

        btnBuscarTrabajador.setBackground(new java.awt.Color(58, 159, 171));
        btnBuscarTrabajador.setForeground(new java.awt.Color(255, 255, 255));
        btnBuscarTrabajador.setText("BUSCAR TRABAJADOR");
        btnBuscarTrabajador.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnBuscarTrabajador.setFont(new java.awt.Font("Roboto Medium", 1, 14)); // NOI18N
        btnBuscarTrabajador.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuscarTrabajadorActionPerformed(evt);
            }
        });
        jPanel4.add(btnBuscarTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 380, 250, 50));

        codigoTrabajador.setText("codigoTrabajador");
        codigoTrabajador.setVisible(false);
        jPanel4.add(codigoTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, -1, -1));

        panel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 420, 450));
        ...
        id.setText("id");
        jPanel3.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, 30, -1));

        panel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, 459, 190));

        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 476, 620));
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        if (this.txtUsuario.getText().equals("") 
                ...
                || this.txtTrabajador.getText().equals("")
            ...
            if (this.txtPassword.getText().length() <= 7) {
                ...
                if (this.registrar.getText().equals("GUARDAR")) {
                    ...
                    if (UsuarioDAO.verificaUsuario(this.txtUsuario.getText())
                        ...
                        s.setIdTrabajador(this.codigoTrabajador.getText());
                        int opcion = UsuarioDAO.actualizar(s);
                        if (opcion != 0) {
                            UsuarioDAO.listar("");
                    ...
                    if (UsuarioDAO.verificaUsuario(this.txtUsuario.getText())) {
                        ...
                        s.setTipo(this.tipo.getSelectedItem().toString());
                        s.setIdTrabajador(this.codigoTrabajador.getText());
                        int opcion = UsuarioDAO.registrar(s);
                        if (opcion != 0) {
                            limpiarCampos();
                            SuccessAlert sa = new SuccessAlert(new JFrame(), true);
                            sa.titulo.setText("¡REGISTRO EXITOSO!");
    ...
    private void btnBuscarTrabajadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarTrabajadorActionPerformed
      // new usuarios.FormTrabajadoresUsuario(new JFrame(), true).setVisible(true);
      FormTrabajadoresUsuario form = new FormTrabajadoresUsuario(new JFrame(), true);
      form.setVisible(true);
      this.txtTrabajador.setText(form.nombreTrabajador);
      this.codigoTrabajador.setText(form.codigoTrabajador);
    ...
    private principal.MaterialButton btnBuscarTrabajador;
    private principal.MaterialButton cerrar;
    public static javax.swing.JLabel codigoTrabajador;
    ...
    public static app.bolivia.swing.JCTextField txtTrabajador;
