...
public class FormTrabajadoresUsuario extends javax.swing.JDialog {

    /**
     * Creates new form Principal
     */
    public FormTrabajadoresUsuario(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        UsuarioDAO.listarTrabajadores("");
      //  producto.ProductoDAO.iniciarTransaccion();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRE", "APELLIDO", "DIRECCIÓN", "TELEFONO", "EMAIL", "CARGO"
            }
        ) {
...
//        FadeEffect.fadeOut(this, 50, 0.1f);
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        UsuarioDAO.listarTrabajadores(this.buscar.getText());
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                // Obtén el valor de la columna 1 (indexada desde 0, por lo que la columna 1 es en realidad la columna 0)
                this.codigoTrabajador = this.tabla.getValueAt(fila, 0).toString();
                this.nombreTrabajador = this.tabla.getValueAt(fila, 1).toString() + ", " + this.tabla.getValueAt(fila, 2).toString();
                this.dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTrabajadoresUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormTrabajadoresUsuario dialog = new FormTrabajadoresUsuario(new javax.swing.JFrame(), true);
