...
public class FormUsuarios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "USUARIO", "TRABAJADOR", "CONTRASEÑA", "TIPO USUARIO", "CODTRABAJADOR"
            }
        ) {
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                mp.txtTrabajador.setText(this.tabla.getValueAt(fila, 2).toString());
                mp.txtPassword.setText(this.tabla.getValueAt(fila, 3).toString());
                mp.tipo.setSelectedItem(this.tabla.getValueAt(fila, 4).toString());
                mp.nombreUs.setText(this.tabla.getValueAt(fila, 1).toString());
                mp.codigoTrabajador.setText(this.tabla.getValueAt(fila, 5).toString());
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        UsuarioDAO.listar(this.buscar.getText());
